...
public class DiffMatchPatchTest {
  ...
  public static void testDiffLinesToChars() {
    ...
    tmpVector.add("a");
    tmpVector.add("b");
    assertLinesToCharsResultEquals("diff_linesToChars: No linebreaks.", new DiffMatchPatch.LinesToCharsResult("\u0001", "\u0002", tmpVector), dmp.diff_linesToChars("a", "b"));
    ...
    tmpVector.add(0, "");
    assertLinesToCharsResultEquals("diff_linesToChars: More than 256.", new DiffMatchPatch.LinesToCharsResult(chars, "", tmpVector), dmp.diff_linesToChars(lines, ""));
  }

  public static void testDiffCharsToLines() {
    // First check that Diff equality works.
    assertTrue("diff_charsToLines: Equality #1.", new DiffMatchPatch.Diff(EQUAL, "a").equals(new DiffMatchPatch.Diff(EQUAL, "a")));

    assertEquals("diff_charsToLines: Equality #2.", new DiffMatchPatch.Diff(EQUAL, "a"), new DiffMatchPatch.Diff(EQUAL, "a"));
    ...
    assertEquals("diff_charsToLines: Shared lines.", diffList(new DiffMatchPatch.Diff(EQUAL, "alpha\nbeta\nalpha\n"), new DiffMatchPatch.Diff(INSERT, "beta\nalpha\nbeta\n")), diffs);
    ...
    dmp.diff_charsToLines(diffs, tmpVector);
    assertEquals("diff_charsToLines: More than 256.", diffList(new DiffMatchPatch.Diff(DELETE, lines)), diffs);
    ...
    DiffMatchPatch.LinesToCharsResult results = dmp.diff_linesToChars(chars, "");
    diffs = diffList(new DiffMatchPatch.Diff(INSERT, results.chars1));
  ...
  public static void testDiffCleanupMerge() {
    ...
    dmp.diff_cleanupMerge(diffs);
    assertEquals("diff_cleanupMerge: No change case.", diffList(new DiffMatchPatch.Diff(EQUAL, "a"), new DiffMatchPatch.Diff(DELETE, "b"), new DiffMatchPatch.Diff(INSERT, "c")), diffs);

    diffs = diffList(new DiffMatchPatch.Diff(EQUAL, "a"), new DiffMatchPatch.Diff(EQUAL, "b"), new DiffMatchPatch.Diff(EQUAL, "c"));
    dmp.diff_cleanupMerge(diffs);
    assertEquals("diff_cleanupMerge: Merge equalities.", diffList(new DiffMatchPatch.Diff(EQUAL, "abc")), diffs);

    diffs = diffList(new DiffMatchPatch.Diff(DELETE, "a"), new DiffMatchPatch.Diff(DELETE, "b"), new DiffMatchPatch.Diff(DELETE, "c"));
    dmp.diff_cleanupMerge(diffs);
    assertEquals("diff_cleanupMerge: Merge deletions.", diffList(new DiffMatchPatch.Diff(DELETE, "abc")), diffs);

    diffs = diffList(new DiffMatchPatch.Diff(INSERT, "a"), new DiffMatchPatch.Diff(INSERT, "b"), new DiffMatchPatch.Diff(INSERT, "c"));
    dmp.diff_cleanupMerge(diffs);
    assertEquals("diff_cleanupMerge: Merge insertions.", diffList(new DiffMatchPatch.Diff(INSERT, "abc")), diffs);
    ...
    dmp.diff_cleanupMerge(diffs);
    assertEquals("diff_cleanupMerge: Merge interweave.", diffList(new DiffMatchPatch.Diff(DELETE, "ac"), new DiffMatchPatch.Diff(INSERT, "bd"), new DiffMatchPatch.Diff(EQUAL, "ef")), diffs);

    diffs = diffList(new DiffMatchPatch.Diff(DELETE, "a"), new DiffMatchPatch.Diff(INSERT, "abc"), new DiffMatchPatch.Diff(DELETE, "dc"));
    dmp.diff_cleanupMerge(diffs);
    assertEquals("diff_cleanupMerge: Prefix and suffix detection.", diffList(new DiffMatchPatch.Diff(EQUAL, "a"), new DiffMatchPatch.Diff(DELETE, "d"), new DiffMatchPatch.Diff(INSERT, "b"), new DiffMatchPatch.Diff(EQUAL, "c")), diffs);
    ...
    dmp.diff_cleanupMerge(diffs);
    assertEquals("diff_cleanupMerge: Prefix and suffix detection with equalities.", diffList(new DiffMatchPatch.Diff(EQUAL, "xa"), new DiffMatchPatch.Diff(DELETE, "d"), new DiffMatchPatch.Diff(INSERT, "b"), new DiffMatchPatch.Diff(EQUAL, "cy")), diffs);

    diffs = diffList(new DiffMatchPatch.Diff(EQUAL, "a"), new DiffMatchPatch.Diff(INSERT, "ba"), new DiffMatchPatch.Diff(EQUAL, "c"));
    dmp.diff_cleanupMerge(diffs);
    assertEquals("diff_cleanupMerge: Slide edit left.", diffList(new DiffMatchPatch.Diff(INSERT, "ab"), new DiffMatchPatch.Diff(EQUAL, "ac")), diffs);

    diffs = diffList(new DiffMatchPatch.Diff(EQUAL, "c"), new DiffMatchPatch.Diff(INSERT, "ab"), new DiffMatchPatch.Diff(EQUAL, "a"));
    dmp.diff_cleanupMerge(diffs);
    assertEquals("diff_cleanupMerge: Slide edit right.", diffList(new DiffMatchPatch.Diff(EQUAL, "ca"), new DiffMatchPatch.Diff(INSERT, "ba")), diffs);
    ...
    dmp.diff_cleanupMerge(diffs);
    assertEquals("diff_cleanupMerge: Slide edit right recursive.", diffList(new DiffMatchPatch.Diff(EQUAL, "xca"), new DiffMatchPatch.Diff(DELETE, "cba")), diffs);

    diffs = diffList(new DiffMatchPatch.Diff(DELETE, "b"), new DiffMatchPatch.Diff(INSERT, "ab"), new DiffMatchPatch.Diff(EQUAL, "c"));
    dmp.diff_cleanupMerge(diffs);
    assertEquals("diff_cleanupMerge: Empty merge.", diffList(new DiffMatchPatch.Diff(INSERT, "a"), new DiffMatchPatch.Diff(EQUAL, "bc")), diffs);

    diffs = diffList(new DiffMatchPatch.Diff(EQUAL, ""), new DiffMatchPatch.Diff(INSERT, "a"), new DiffMatchPatch.Diff(EQUAL, "b"));
    dmp.diff_cleanupMerge(diffs);
    assertEquals("diff_cleanupMerge: Empty equality.", diffList(new DiffMatchPatch.Diff(INSERT, "a"), new DiffMatchPatch.Diff(EQUAL, "b")), diffs);
  }
  ...
  public static void testDiffCleanupSemanticLossless() {
    ...
    dmp.diff_cleanupSemanticLossless(diffs);
    assertEquals("diff_cleanupSemanticLossless: Word boundaries.", diffList(new DiffMatchPatch.Diff(EQUAL, "The "), new DiffMatchPatch.Diff(INSERT, "cow and the "), new DiffMatchPatch.Diff(EQUAL, "cat.")), diffs);

    diffs = diffList(new DiffMatchPatch.Diff(EQUAL, "The-c"), new DiffMatchPatch.Diff(INSERT, "ow-and-the-c"), new DiffMatchPatch.Diff(EQUAL, "at."));
    dmp.diff_cleanupSemanticLossless(diffs);
    assertEquals("diff_cleanupSemanticLossless: Alphanumeric boundaries.", diffList(new DiffMatchPatch.Diff(EQUAL, "The-"), new DiffMatchPatch.Diff(INSERT, "cow-and-the-"), new DiffMatchPatch.Diff(EQUAL, "cat.")), diffs);

    diffs = diffList(new DiffMatchPatch.Diff(EQUAL, "a"), new DiffMatchPatch.Diff(DELETE, "a"), new DiffMatchPatch.Diff(EQUAL, "ax"));
    dmp.diff_cleanupSemanticLossless(diffs);
    assertEquals("diff_cleanupSemanticLossless: Hitting the start.", diffList(new DiffMatchPatch.Diff(DELETE, "a"), new DiffMatchPatch.Diff(EQUAL, "aax")), diffs);

    diffs = diffList(new DiffMatchPatch.Diff(EQUAL, "xa"), new DiffMatchPatch.Diff(DELETE, "a"), new DiffMatchPatch.Diff(EQUAL, "a"));
    dmp.diff_cleanupSemanticLossless(diffs);
    assertEquals("diff_cleanupSemanticLossless: Hitting the end.", diffList(new DiffMatchPatch.Diff(EQUAL, "xaa"), new DiffMatchPatch.Diff(DELETE, "a")), diffs);
    ...
    dmp.diff_cleanupSemanticLossless(diffs);
    assertEquals("diff_cleanupSemanticLossless: Sentence boundaries.", diffList(new DiffMatchPatch.Diff(EQUAL, "The xxx."), new DiffMatchPatch.Diff(INSERT, " The zzz."), new DiffMatchPatch.Diff(EQUAL, " The yyy.")), diffs);
  }
  ...
  public static void testDiffCleanupEfficiency() {
    ...
    dmp.diff_cleanupEfficiency(diffs);
    assertEquals("diff_cleanupEfficiency: No elimination.", diffList(new DiffMatchPatch.Diff(DELETE, "ab"), new DiffMatchPatch.Diff(INSERT, "12"), new DiffMatchPatch.Diff(EQUAL, "wxyz"), new DiffMatchPatch.Diff(DELETE, "cd"), new DiffMatchPatch.Diff(INSERT, "34")), diffs);
    ...
    dmp.diff_cleanupEfficiency(diffs);
    assertEquals("diff_cleanupEfficiency: Four-edit elimination.", diffList(new DiffMatchPatch.Diff(DELETE, "abxyzcd"), new DiffMatchPatch.Diff(INSERT, "12xyz34")), diffs);
    ...
    dmp.diff_cleanupEfficiency(diffs);
    assertEquals("diff_cleanupEfficiency: Three-edit elimination.", diffList(new DiffMatchPatch.Diff(DELETE, "xcd"), new DiffMatchPatch.Diff(INSERT, "12x34")), diffs);
    ...
    dmp.diff_cleanupEfficiency(diffs);
    assertEquals("diff_cleanupEfficiency: Backpass elimination.", diffList(new DiffMatchPatch.Diff(DELETE, "abxyzcd"), new DiffMatchPatch.Diff(INSERT, "12xy34z56")), diffs);

    dmp.Diff_EditCost = 5;
    diffs = diffList(new DiffMatchPatch.Diff(DELETE, "ab"), new DiffMatchPatch.Diff(INSERT, "12"), new DiffMatchPatch.Diff(EQUAL, "wxyz"), new DiffMatchPatch.Diff(DELETE, "cd"), new DiffMatchPatch.Diff(INSERT, "34"));
    dmp.diff_cleanupEfficiency(diffs);
    assertEquals("diff_cleanupEfficiency: High cost elimination.", diffList(new DiffMatchPatch.Diff(DELETE, "abwxyzcd"), new DiffMatchPatch.Diff(INSERT, "12wxyz34")), diffs);
    dmp.Diff_EditCost = 4;
  }
  ...
  public static void testDiffDelta() {
    ...
    diffs = diffList(new DiffMatchPatch.Diff(INSERT, a));
    delta = dmp.diff_toDelta(diffs);
