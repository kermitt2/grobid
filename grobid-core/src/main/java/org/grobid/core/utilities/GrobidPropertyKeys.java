...
public interface GrobidPropertyKeys {
    ...
    String PROP_GROBID_VERSION = "grobid.version";
     ...
     */
    String PROP_CROSSREF_MAILTO = "grobid.crossref.mailto";
     ...
     */
    String PROP_CROSSREF_TOKEN = "grobid.crossref.token";
    ...
    String PROP_GROBID_MAX_CONNECTIONS = "grobid.max.connections";
    String PROP_GROBID_POOL_MAX_WAIT = "grobid.pool.max.wait";

    String PROP_GLUTTON_HOST = "grobid.glutton.host";
    String PROP_GLUTTON_PORT = "grobid.glutton.port";
     ...
     */
    String PROP_GROBID_HOME = "grobid.home";

    /**
     * The name of the env-entry located in the web.xml, via which the
     * grobid.propeties path is set.
     */
    String PROP_GROBID_PROPERTY = "grobid.property";

    /**
     * The name of the system property, via which the grobid home folder can be
     * located.
     */
//    String PROP_GROBID_SERVICE_PROPERTY = "grobid.property.service";

    /**
     * name of the property setting the admin password
     */
    String PROP_GROBID_SERVICE_ADMIN_PW = "grobid.service.admin.pw";

    /**
     * If set to true, parallel execution will be done, else a queuing of
     * requests will be done.
     */
    String PROP_GROBID_SERVICE_IS_PARALLEL_EXEC = "grobid.service.is.parallel.execution";
