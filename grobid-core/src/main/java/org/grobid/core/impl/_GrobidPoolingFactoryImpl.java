...
import org.grobid.core._GrobidPoolingFactory;
import org.grobid.core.engines.Engine;
import org.grobid.core.main.LibraryLoader;

public class _GrobidPoolingFactoryImpl implements _GrobidPoolingFactory {
		...
		if (grobidEnginePool == null) {
			...
			synchronized (grobidEnginePoolControl) {
				if (grobidEnginePool == null) {
					...
					grobidEnginePool
							.setFactory(_GrobidPoolingFactory.newInstance);
					grobidEnginePool
	 ...
	 * @return
	 */
	public static _GrobidPoolingFactory newInstance() {
		init();
		return (new _GrobidPoolingFactoryImpl());
	}
