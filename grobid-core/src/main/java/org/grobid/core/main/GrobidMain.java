...
public class GrobidMain {
	static private Engine engine = GrobidFactory.getInstance().createEngine();
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(engine.fullTextToTEI("/tmp/paper-08.pdf", false,
				false));
		// engine.processHeader("/Users/zholudev/Dropbox/problem.pdf", false,
		// null);
		// String reference =
		...
		// String reference2 =
		// "Lipman DJ: Gapped BLAST and PSI-BLAST: a new generation of protein database  search programs.    Nucleic Acid Res 1997 25:3389-3402";
		 ...
		 * "Please provide just one affiliation address string to process");
		 * System.exit(-1); } for (Affiliation a :
		 * engine.processAffiliation(args[0])) { System.out.println(a); }
		 */
		// engine.close();
