...
//	private BiblioItem resHeader = null;
            ...
            if (isNotBlank(resHeader.getAbstract())) {
                ...
                if (CollectionUtils.isNotEmpty(abstractTokens)) {
                    ...
                    for (LayoutToken token : abstractTokens) {
                        int indexPosition = getDocIndexToken(doc, token);
                        if (start) {
                            start = false;
                        ...
                        DocumentPointer dp1 = new DocumentPointer(doc, previousToken.getBlockPtr(), previousPosition);
                        DocumentPointer dp2 = new DocumentPointer(doc, token.getBlockPtr(), indexPosition);
                    ...
                    String resultsLabeledAbstract = null;
                    ...
                    if (featSeg != null) {
                        ...
                        if (isNotEmpty(trim(abstractText)))
                            resultsLabeledAbstract = label(abstractText);
                        resHeader.setLabeledAbstract(resultsLabeledAbstract);
    ...
    public Pair<String, LayoutTokenization> getBodyTextFeatured(Document doc,
...
//System.out.println((density-doc.getMinCharacterDensity()) + " " + (doc.getMaxCharacterDensity()-doc.getMinCharacterDensity()) + " " + NBBINS_DENSITY + " " + features.characterDensity);
     ...
     */
    private int getDocIndexToken(Document doc, LayoutToken token) {
