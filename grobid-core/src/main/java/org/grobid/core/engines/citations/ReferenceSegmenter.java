 ...
 * Date: 2/26/14
 */
public class ReferenceSegmenter {
    ...
    private static final CitationTextSegmenter citationTextSegmenter = new CitationTextSegmenter();
    ...
    public static List<String> segmentReferences(Iterable<String> tokenizations) {
        return segmentReferences(Joiner.on("").join(tokenizations));
    }
