...
public class MonographParser extends AbstractParser {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(org.grobid.core.engines.MonographParser.class);
        ...
        try {
            ...
            while (resultByLines.hasMoreTokens()) {
                ...
                if (lastTag == null) { // only for the first line
                    ...
                    if (!label.equals(lastTag) && (firstLine == null)) { // check if the label is actually the same
    ...
    public Document createBlankTrainingFromPDF(File inputFile,
        ...
        try {
            ...
            if (blocks == null) {
                ...
                // String rawText = getAllLinesFeatured(doc); // featured data by lines
                String rawText = getAllBlocksFeatured(doc); // featured data by blocks
