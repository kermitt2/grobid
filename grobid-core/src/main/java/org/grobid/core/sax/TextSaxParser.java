 ...
 * <p/>
 * As an option, it is possible to accumulate only the content under a given element name, for instance
 * "description" for getting the description of a patent XML document.
 *
...
public class TextSaxParser extends DefaultHandler {
    ...
    private String filter = null; // the name of an element for getting only the corresponding text
