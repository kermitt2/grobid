Individual models can be evaluated as explained in [Training the different models of Grobid](https://github.com/grobid/grobid/wiki/Training-the-models-of-Grobid).
