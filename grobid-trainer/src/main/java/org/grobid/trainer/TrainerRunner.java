...
public class TrainerRunner {
    ...
    private static final List<String> models = Arrays.asList("acknowledgment","affiliation", "chemical", "date", "citation", "ebook", "fulltext", "header", "name-citation", "name-header", "patent");
