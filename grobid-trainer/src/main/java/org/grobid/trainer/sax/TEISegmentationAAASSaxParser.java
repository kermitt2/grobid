 ...
 */
public class TEISegmentationAAASSaxParser extends TEISegmentationSaxParser {
  	...
  	/* TEI -> label mapping (10 labels for this model)
		...
		NOTE: This flavour put every statements: "funding" "availability" into "acknowledgement"
 	*/

    private static final Logger logger = LoggerFactory.getLogger(TEISegmentationAAASSaxParser.class);
    ...
    public TEISegmentationAAASSaxParser() {
