...
public class TEISegmentationThesisRefSaxParser extends TEISegmentationSaxParser {

    private static final Logger logger = LoggerFactory.getLogger(TEISegmentationThesisRefSaxParser.class);
    ...
    public TEISegmentationThesisRefSaxParser() {
