 ...
 */
public class TEIFulltextArticleAaasSaxParser extends TEIFulltextSaxParser {
    private static final Logger logger = LoggerFactory.getLogger(TEIFulltextArticleAaasSaxParser.class);
    ...
    public TEIFulltextArticleAaasSaxParser() {
